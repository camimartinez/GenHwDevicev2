...
public class MonitorImpl extends MonitorPointImpl implements Monitor {
	...
	public void setAux7(BaseFactoryImpl newAux7) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmbPackage.MONITOR__AUX7, oldAux7, aux7));
	}
	...
	public void setAux3(Resource newAux3) {
		...
		aux3 = newAux3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmbPackage.MONITOR__AUX3, oldAux3, aux3));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AmbPackage.MONITOR__AUX7:
				return getAux7();
			case AmbPackage.MONITOR__MAC:
				return getMac();
			case AmbPackage.MONITOR__AUX2:
				return getAux2();
			case AmbPackage.MONITOR__AUX3:
				return getAux3();
