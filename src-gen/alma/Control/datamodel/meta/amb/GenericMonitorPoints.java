 ...
 *   <li>{@link alma.Control.datamodel.meta.amb.GenericMonitorPoints#getToGetSpreadsheet <em>To Get Spreadsheet</em>}</li>
...
public interface GenericMonitorPoints extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>To Get Spreadsheet</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>To Get Spreadsheet</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>To Get Spreadsheet</em>' reference.
	 * @see #setToGetSpreadsheet(SpreadsheetParser)
	 * @see alma.Control.datamodel.meta.amb.AmbPackage#getGenericMonitorPoints_ToGetSpreadsheet()
	 * @model
	 * @generated
	 */
	SpreadsheetParser getToGetSpreadsheet();

	/**
	 * Sets the value of the '{@link alma.Control.datamodel.meta.amb.GenericMonitorPoints#getToGetSpreadsheet <em>To Get Spreadsheet</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>To Get Spreadsheet</em>' reference.
	 * @see #getToGetSpreadsheet()
	 * @generated
	 */
	void setToGetSpreadsheet(SpreadsheetParser value);
