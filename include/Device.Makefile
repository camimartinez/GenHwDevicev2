...
#
# $Id: Device.Makefile 199109 2013-12-18 18:37:52Z rmarson $
#
#******************************************************************************
...
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/commons-cli-1.3.1.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/commons-lang3-3.5.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/commons-logging-1.2.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/emf_v2.13.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/icu4j-57_1.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/log4j-1.2.17.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/maciSchemaBindings.jar:
GEN_CLASSPATH += $(GenHwLocation)$(GenHwDir)/lib/mwe_v2.8.3.jar:
...
../object/generation.done: $(SPREADSHEET_ICD) $(GEN_TEMPLATES_DEPEND $(GenHwLocation)/$(GenHwDir)/lib/ControlGenHwDevicev2.jar
