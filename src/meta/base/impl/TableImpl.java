 ...
 * <ul>
 *   <li>{@link meta.base.impl.TableImpl#getDepChar <em>Dep Char</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getCelsiusToKelvin <em>Celsius To Kelvin</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getSheetNames <em>Sheet Names</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getColNames <em>Col Names</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getTagNames <em>Tag Names</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToCPP <em>To CPP</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToIDL <em>To IDL</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToIDLSeq <em>To IDL Seq</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToCORBA <em>To CORBA</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToCORBASeq <em>To CORBA Seq</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToCORBADevIO <em>To CORBA Dev IO</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToBACI <em>To BACI</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getToDatabase <em>To Database</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getRawToCPP <em>Raw To CPP</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getRawToByteSwapped <em>Raw To Byte Swapped</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getRawBytes <em>Raw Bytes</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToCPP <em>World To CPP</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToIDL <em>World To IDL</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToIDLSeq <em>World To IDL Seq</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToCORBA <em>World To CORBA</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToCORBASeq <em>World To CORBA Seq</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToCORBADevIO <em>World To CORBA Dev IO</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToBACI <em>World To BACI</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToJava <em>World To Java</em>}</li>
 *   <li>{@link meta.base.impl.TableImpl#getWorldToDatabase <em>World To Database</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
