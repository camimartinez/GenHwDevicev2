 ...
 * @generated
 */
public class AmbSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AmbPackage.MAIN: {
				Main main = (Main)theEObject;
				T result = caseMain(main);
				if (result == null) result = caseMainBase(main);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmbPackage.MAND_C: {
				MandC mandC = (MandC)theEObject;
				T result = caseMandC(mandC);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AmbPackage.MONITOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mand C</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mand C</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMandC(MandC object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseBase_DeviceModel(alma.control.datamodel.meta.base.DeviceModel object) {
		return null;
	}
